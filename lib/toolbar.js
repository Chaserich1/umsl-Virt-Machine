  ...
  module.exports = [
    {
      ...
      callback: function(target){
        ...
        var packagePath = atom.packages.resolvePackagePath("package")



        atom.config.set('platformio-ide-terminal.customTexts.customText1', `${packagePath}/lib/./assemblyVirtMach ${fileName}`)
    ...
    },
    {
      ...
      type: "url",
      url: "https://gitlab.com/505BadGroupName/project-reboot/blob/chases-branch/helpmarkdown.md",
      text: "ToolTips",
      icon: "tools",
      style: {
        color: "#ffbf00"
      ...
      type: "url",
      url: "https://gitlab.com/505BadGroupName/project-reboot/blob/chases-branch/templatemarkdown.md",
      ...
      type: "url",
      url: "https://gitlab.com/505BadGroupName/project-reboot/blob/master/Instuctions%20for%20Group%20Project.pdf",
      text: "Documentation",
      icon: "list-unordered",
      style: {
        color: "#ffbf00"
